...
public class PlayerInfoPacket implements NMSPlayerInfoPacket {
        ...
        for(NMSPlayerInfoAction action : actionList) {
            switch(actionEnum) {
                case ADD_PLAYER:
                    ...
                    var1.d(action.getPropertiesToAdd().size());
                    ...
                    var1.d(action.getGamemode());
                    var1.d(action.getPing());
    ...
    public static PlayerInfoPacket of(Object nmsPacket) throws IOException {
        ...
        for(int var3 = 0; var3 < actionCount; ++var3) {
            ...
            switch(action) {
                case ADD_PLAYER:
                    String name = var1.e(16);
                    int propertiesCount = var1.g();
                    List<ProfileProperty> profileProperties = new ArrayList<>();
                    for(int i = 0; i < propertiesCount; i++) {
                        String propertyName = var1.e(32767);
                        String propertyValue = var1.e(32767);
                        if (var1.readBoolean()) { // hasSignature
                            String signature = var1.e(32767);
                    ...
                    ping = var1.g();
                    if (var1.readBoolean()) {
                        displayName = IChatBaseComponent.ChatSerializer.a(var1.f());
                    }
